...
## MILESTONE THREE:
**GOAL: ADD A POWER SUPPLY AND TRIGGER THE BUILT LED ON THE RELAY**
 > (SHOW DIAGRAM)
1. _CONNECT WIRES_:
...
## MILESTONE FOUR:
**GOAL: PHYISICALLY SPLICE THE RELAY INTO THE LIGHT LINE**
1. _ITALICS DIRECTIVE_:
    1. CAPS INSTRUCTION DETAIL
    2. CAPS INSTRUCTION DETAIL
        1. ...
**STATUS UPDATE**
2. *BLAH*
    1. BLAH
