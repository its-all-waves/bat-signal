...
## MILESTONE THREE:
- ADD A POWER SUPPLY AND TRIGGER THE BUILT LED ON THE RELAY
	- (SHOW DIAGRAM)
1. MAKE SURE THE D0 SIDE PIN OF BREADBOARD IS SET TO 3.3V ON THE POWER SUPPLY
	1. (SHOW DIAGRAM)
2. TAP INTO THAT SIDE OF THE POWER SUPPLY FOR THE RELAY
3. GROUND FROM BREADBOARD GOES TO GROUND ON THE RELAY
4. POSITIVE FROM THE BREADBOARD GOES TO VCC ON THE RELAY
5. THE DATA PIN GOES INTO THE "IN" CONNECTION ON THE RELAY
	1. OUR DATA PIN IS "D6" (D6 CONTROLS THE RELAY)
- CONNECTION IS NOW ESTABLISHED (RELAY IS CONNECTED TO THE BOARD)
1. GRAB A 9V BATTERY AND ATTACH IT TO THE BATTERY ADAPTER
	1. PLUG THAT INTO THE POWER SUPPLY
	2. (DOUBLE CHECK TO NOT BE CONFUSING +/- GOING INTO THE RELAY)
	3. (DOUBLE CHECK THAT POWER CONNECTIONS ARE GETTING 3.3V FROM THE POWER SUPPLY)
2. TURN ON THE POWER SUPPLY WITH PHYSICAL BUTTON ON IT
3. **CODE**
